        ...
        <div className='mx-auto top-6 absolute  w-[100%] '>
            ...
            <div className=' bg-transparent  top-9 justify-between md:justify-normal mx-0  lg:mx-20 my-auto flex text sticky z-50  gap-20 px-8'>
                ...
                <div className='hidden text-white font-normal  md:flex my-auto lg:gap-7 md:gap-5'>
                    <Link to="/" >
                        <a className='hover:text-[#86C8D3]  md:text-[13px]  lg:text-[17.5px] duration-300 ' href="#home">Home</a>
                    </Link>
                    <Link to="/team" >
                        <a className='hover:text-[#86C8D3] md:text-[13px] lg:text-[17.5px] duration-300' href="">Team</a>
                    </Link>
                    <Link to='/alumni'>
                        <a className='hover:text-[#86C8D3] md:text-[13px] lg:text-[17.5px] duration-300' href="">Alumni</a>
                    </Link>
                    <Link to="/gallery">
                        <a className='hover:text-[#86C8D3] md:text-[13px] lg:text-[17.5px] duration-300' href="">Gallery</a>
                    </Link>
                    <Link to="/startups">
                    <a className='hover:text-[#86C8D3] md:text-[13px] lg:text-[17.5px] duration-300' href="">Initiatives</a>
                    </Link>
                    <Link to="/internship">
                        <a className='hover:text-[#86C8D3] md:text-[13px] lg:text-[17.5px] duration-300' href="#contact">Internship</a>
                    </Link>
                    <Link to="/document">
                        <a className='hover:text-[#86C8D3] md:text-[13px] lg:text-[17.5px] duration-300' href="">Documents</a>
                    </Link>
                </div>
