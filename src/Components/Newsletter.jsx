...
const Newsletter = () => {
    return (
        <div className='py-16 w-[91%] md:w-[84.4%] justify-center gap-6  lg:gap-32 flex flex-col-reverse md:flex-row bg-[#A1A6DC] rounded-2xl -mb-10  mt-28 mx-auto relative '>
