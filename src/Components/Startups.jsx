...
import copppercloud from '../assets/Startups/coppercloud.jpg'
    ...
    return (
        <div >
            ...
            <div className='relative w-[100%]   bg-[#0F1322]'>
                <div className='relative mx-auto   justify-center align-middle top-[95px] h-[508em]  md:h-[262em]   w-[94%]  rounded-3xl bg-[#86C8D3]'>
                    ...
                    <div className='relative  -top-28 flex flex-col max-w-[98%] gap-28 mx-auto'>
                        <h1 className='relative  text-[#0F1322]  font-bold text-2xl  md:text-4xl flex justify-center text-center w-[100%] '>Startup by AIT Alumnis</h1>
