    ...
    return (
        <div >
            ...
            <div className='relative w-[100%]   bg-[#0F1322]'>
                <div className='relative mx-auto justify-center align-middle top-[95px] lg:h-[42em]  md:h-[45em] h-[34em] mb-4   w-[94%]  rounded-3xl bg-[#545A88]'>
                    ...
                    <div className='absolute top-[4em] mx-auto flex justify-center w-[100%]'>
                        <img className='w-[76%] top-3 absolute h-[20em] md:h-[39em] flex align-middle justify-center items-center' src={splash} alt="" />
