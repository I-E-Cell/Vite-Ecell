...
function AlumniCard(props) {
    return (
        <div className='w-[18em] z-10 relative  h-[15em] bg-[#1C1F2B] rounded-3xl'>
            <div className='flex absolute  w-[12.5em] h-[4.5em] -top-[2em] rounded-2xl bg-[#1C1F2B]'>
                <div className='absolute left-[10.95em] w-[2em] top-2 skew-x-[30deg] h-[2em] flex  bg-[#1C1F2B] '>

                </div>
                <div className='relative text-[22px] font-semibold left-2 top-[4px] text-[#86C8D3]'>
                    <h1>{props.name}</h1>
                </div>
            </div>
            <div className='flex absolute left-[5em] top-[13em]  w-[13em] h-[4em]  justify-end rounded-2xl bg-[#1C1F2B]'>
                <div className='absolute w-[2em] h-[1.2em] flex right-[13em] bg-[#1C1F2B] top-[2em]'>
                    ...
                    <a target='_blank' href={props.linkedin}><FaLinkedinIn  size={23} className='relative icon -left-3 top-1 '/></a>

                    </div>

                </div>
                <div className='text-white text-sm relative  h-[50%] justify-center flex font-medium top-4 text-center w-[92%] '><h1>{props.position}</h1></div>
