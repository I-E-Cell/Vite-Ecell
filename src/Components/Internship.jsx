                        ...
                        <div className='py-6 w-[91%] md:w-[87.4%] lg:w-[78.4%] justify-center gap-6  lg:gap-32 flex flex-col-reverse md:flex-row bg-[#1C1F2B] rounded-2xl mx-auto relative '>
                            ...
                            <div className=' w-[90%] relative mx-auto md:mx-0 text-center md:text-start'>
                                ...
                                <div className='w-[90%] md:w-[80%] mx-auto md:mx-10 '>
                                    <label className='text-base font-semibold text-white mr-3' htmlFor="fname">Name :</label>
                                    ...
                                    <label className='text-base mr-3 font-semibold text-white' htmlFor="">Role :</label>
                                    ...
                                    <label className='text-base  mr-3 font-semibold text-white' htmlFor="">Link :</label>
                                    ...
                                    <label className='text-base mr-3 font-semibold text-white' htmlFor="">Email :</label>
