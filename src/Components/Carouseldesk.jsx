  ...
  return (
    ...
    <div className='w-[91%] md:w-[84.4%] hidden lg:flex justify-center mt-10 mx-auto rounded-2xl bg-[#1C1F2B] px-16 py-16' >
      ...
      >
        ...
        <SwiperSlide><Card_blue img={awanishpandey} name="Mr. Awanish Pandey" msg="As a proud alumnus of AIT, witnessing the I&E cell's commitment to nurturing entrepreneurship is truly commendable. The array of initiatives undertaken in recent years promises a bright future for AITian startups, destined to make a mark in the Indian startup landscape. 
Wishing the I&E cell continued success and looking forward to seeing AIT alumni leading the way in innovation and entrepreneurship."/></SwiperSlide>
