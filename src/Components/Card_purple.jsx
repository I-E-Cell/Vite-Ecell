  ...
  return (
    <div className='flex justify-center  text-center'>
            ...
            <div className='rounded-full relative top-3  flex'>
                ...
                <h2 className='max-w-[83%]  md:top-2 text-justify text-[11px] review relative mx-auto  '>"{props.msg}"<br /><br /><span  className=' text-[15px] font-semibold'>~ {props.name} </span>
                    </h2>
