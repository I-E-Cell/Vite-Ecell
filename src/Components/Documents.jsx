...
import ECell23 from "../assets/docs/ECell2324.pdf";
    ...
    <>
      <div className="pb-[7em] ">
        ...
        <div className="relative w-[100%]   bg-[#0F1322]">
          <div className="relative mx-auto justify-center align-middle top-[95px]  pb-[7em] md:pb-10   w-[94%]  rounded-3xl bg-[#1C1F2B]">
            <div className=" relative w-[28%]  h-[9.5em] rounded-3xl left-[72%] -top-[75px]   bg-[#1C1F2B]">
              <h1 className="absolute  text-[#e6e6e6] z-10 font-semibold text-xl md:text-3xl lg:text-4xl hidden md:flex justify-center text-center md:left-[20%] lg:left-[26%] top-3">
                Documents
              </h1>
              <div className="s_box rounded-sm w-[68%] lg:-left-[26.5px] -left-[28px] top-[6px]  h-[60%] bg-[#1C1F2B]"></div>
            </div>
            <div className="flex flex-col relative -top-11  lg:flex-row justify-center items-center lg:justify-around gap-28 lg:gap-10">
              <div className="w-[18.5em]  sm:w-[21em] relative top-12 mx-auto md:mx-0 md:w-[28em] lg:w-[32em] h-[12em] rounded-2xl bg-[#A1A6DC]">
                <div className="w-[76%] relative left-[24%] -top-12 h-[10em] rounded-2xl bg-[#A1A6DC]">
                  ...
                  <div className="absolute top-9 left-[36%] translate-x-[-50%]  font-bold z-10 text-lg md:text-2xl">
                    ...
                    <div className="w-[95%] h-[1.4px] rounded-full relative mx-auto bg-[#0F1322]"></div>
                  </div>
                  <div className="w-[32%] h-[40%] bg-[#A1A6DC] relative top-[15px]   -skew-x-12 -left-[36px]"></div>
                ...
                <div className="w-[28%] -top-[120.9%] -left-[4%] md:-left-[3.85%] lg:-left-[4%] relative  z-10  h-[4.5em] border-[13px] border-[#1C1F2B] rounded-full bg-[#A1A6DC]"></div>
              </div>
            ...
            <div className="flex flex-col relative   lg:flex-row justify-center items-center lg:justify-around gap-28 lg:gap-10"></div>

            <div className="flex flex-col gap-28 lg:gap-10  relative top-14 lg:top-8 lg:flex-row justify-center items-center lg:justify-around md:my-20  ">
              <div className="w-[18.5em]  sm:w-[21em] relative top-12 mx-auto md:mx-0 md:w-[28em] lg:w-[32em] h-[13.5em] rounded-2xl bg-[#A1A6DC]">
                <div className="w-[76%] relative left-[24%] -top-12 h-[10em] rounded-2xl bg-[#A1A6DC]">
                  <div className="absolute flex flex-row gap-2 left-[63%]  md:left-[70%] top-2 justify-end">
                    <img className="w-9 h-6" src={ait} alt="" />
                ...
                <div className="w-[28%] -top-[107%] -left-[4%] md:-left-[3.85%] lg:-left-[4%] relative  z-10  h-[4.5em] border-[13px] border-[#1C1F2B] rounded-full bg-[#A1A6DC]"></div>
              </div>
